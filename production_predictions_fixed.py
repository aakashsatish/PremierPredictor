#!/usr/bin/env python3
"""
EPL Tracker - Production Predictions (FIXED)
Uses actual team performance data instead of neutral values
"""
...
def create_production_predictions_fixed(fixtures_df, model, predictors, all_new_cols):
    """Create production predictions using actual team performance data"""
    print("🎯 Creating FIXED production predictions...")
    ...
    for idx, fixture in fixtures_df.iterrows():
        try:
            ...
            # FIXED: Use actual team performance data instead of neutral values
            ...
            # Use home team's features for prediction (since we're predicting home team win)
            actual_rolling_features = home_rolling_features
...
def main():
    """Main function to generate fixed production predictions"""
    print("🚀 EPL Tracker - Production Predictions (FIXED)")
    print("=" * 60)
    print("🎯 Using actual team performance data instead of neutral values")
    print("📊 This should fix incorrect predictions like Wolves vs Man City")
    print("=" * 60)
    ...
    # Create fixed production predictions
    predictions = create_production_predictions_fixed(fixtures_df, model, predictors, all_new_cols)
    
    if predictions:
        # Save predictions
        predictions_df = pd.DataFrame(predictions)
        output_file = "2025_2026_production_predictions_FIXED.csv"
        ...
        print(f"\n📊 FIXED Production Predictions Summary:")
        ...
        print("🎯 Key fixes:")
        print("   - Uses actual team performance data")
        print("   - Should fix Wolves vs Man City type errors")
        print("   - More realistic predictions based on team strength")
        print("   - Better reflects historical dominance")
